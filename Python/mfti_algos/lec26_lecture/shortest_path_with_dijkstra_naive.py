...
# всех оставшихся вершин графа). Это реализация называется жадной
# Дейкстрой, т.к. на каждом шаге мы пробегаемся по всем массиву
# расстояний, пытаясь найти минимальное.
