...
# глупости, начал распечатывать ее прямо на уроке... Шелест золотинки
# услышала учительница. Она хотела вызвать в школу родителей, но Саша
# уговорил ее не вызывать их, а дать дополнительное задание.
#
# Учительница внимательно посмотрела на шоколадку (она была размером
# 3х4 плиток), разделила на кусочки по две плитки и угостила всех, кто
# сделал домашнюю работу. А Сашу попросила написать программу, которая
# определяет, сколько существует способов деления шоколадки размером
# 3×N плиток на кусочки по две плитки.
#
...
# 4       11
#
# Оставляем тот же подход, что было в lec06_arrays. Вероятно, здесь
# предполагалось, что используется сперва более простой метод, а затем,
# при повторном решении этой задачи, используется динамическое
# программирование. Но как видно из формулы
